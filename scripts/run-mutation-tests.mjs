...
const MUTANTS = [
  ...
  },
  {
    ...
    file: 'src/infra/omp-cli-reviewer-adapter.mjs',
    testFile: 'tests/reemit-verbatim.test.mjs',
    original: 'const result = await this.#runner(promptText, cwd, timeout, resolvedModel, {',
    replacement: 'const result = await this.#runner(promptText, cwd, undefined, resolvedModel, {',
